...
export Skyrmion, get_grid, get_field, set_metric_var!, set_mpi!,  set_lattice!, set_Fpi!, set_ee!, set_physical
...
"""
    set_metric_var!(sk::Skyrmion, alpha)

Sets the metric variation to `alpha`.
"""
