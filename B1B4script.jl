...
nuc4 =  Skyrmion([60, 60, 60], [0.2, 0.2, 0.2], mpi = 0.5, Fpi=130, ee=6.5, boundary_conditions="dirichlet")
overview(nuc4)

make_rational_map!(nuc4, pe4, qe4, f4)
Baryon(nuc4)
Energy(nuc4)

gradient_flow!(nuc4,tolerance=0.1,checks=50,dt=0.0004)

arrested_newton_flow!(nuc4, tolerance=0.1, checks=50)
